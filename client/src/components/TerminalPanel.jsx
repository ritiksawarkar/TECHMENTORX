...
export default function TerminalPanel() {
    ...
    try {
      ...
      if (out) {
        ...
        if (inputRect.right > outRect.right) {
          ...
          out.scrollLeft = Math.max(
            0,
            out.scrollLeft - (outRect.left - inputRect.left) - 12,
          );
        }
      }
    } catch (e) {
        ...
        if (!arg || arg === "~") {
          ...
          if (isAbsolute && projectRoot) {
            ...
            if (normArg.startsWith(normRoot.replace(/\\+$/, ""))) {
              ...
              toast.push("cd: path outside project root is not allowed", {
                type: "error",
              });
            }
          } else {
  ...
  return (
    <div className="h-full flex flex-col">
      <div
        className="flex-1 overflow-auto rounded-xl p-3 font-mono text-sm bg-black/50 border border-white/10"
        ref={outRef}
      ...
      >
        {running && log.length === 0 ? (
          ...
          <div className="text-white">
            ...
            <div className="mt-2">
              <div
                className="w-full flex items-center font-mono text-sm text-white/60 min-w-0"
