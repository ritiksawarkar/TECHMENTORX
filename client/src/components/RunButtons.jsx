...
export default function RunButtons() {
  ...
  const onRun = async () => {
    try {
      ...
      if (can && !can()) {
        alert(
          "Daily run limit reached. Change your Run Code Limit in Settings.",
        );
        return;
      }
    } catch {}
    ...
    try {
      ...
      const payload = {
        language_id: active?.languageId ?? languageId,
        source_code: active?.content ?? source,
        stdin,
      };
                ...
                <div className="max-h-[48vh] overflow-y-auto pr-2 space-y-5">
                  <div>
                    ...
                    <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-black/30 px-4 py-3">
                      <div className="flex-1 text-sm text-white/70 break-words">
                        {serverSettings.projectRoot || "Loading..."}
                      </div>
                      <input
                        value={newRoot}
                      ...
                      <button
                        ...
                        onClick={async () => {
                          try {
                            const res = await setProjectRoot(
                              newRoot || serverSettings.projectRoot,
                            );
                    ...
                    <div className="flex items-center justify-between rounded-xl border border-white/10 bg-black/30 px-4 py-3">
                      <div>
                        ...
                        <p className="text-xs text-white/60">
                          Automatically save active file every N seconds.
                        </p>
                      </div>
                      <div className="flex items-center gap-3">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setAutoSaveInterval(Number(e.target.value || 5))
                          }
                  ...
                  <div className="flex items-center justify-between rounded-xl border border-white/10 bg-black/30 px-4 py-3">
                    <div>
                      ...
                      <p className="text-xs text-white/60">
                        Toggle the code overview gutter.
                      </p>
                    </div>
                    <button
                      type="button"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-lg border border-white/15 bg-black/40 px-3 py-2 text-sm text-white outline-none transition focus:border-cyan-400/60 focus:ring-1 focus:ring-cyan-400/40 relative z-50"
                    >
                      <option value="off" style={{ color: "#000" }}>
                        Off
                      </option>
                      <option value="on" style={{ color: "#000" }}>
                        On
                      </option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-lg border border-white/15 bg-black/40 px-3 py-2 text-sm text-white outline-none transition focus:border-cyan-400/60 focus:ring-1 focus:ring-cyan-400/40 relative z-50"
                    >
                      <option value="50" style={{ color: "#000" }}>
                        50
                      </option>
                      <option value="100" style={{ color: "#000" }}>
                        100
                      </option>
                      <option value="200" style={{ color: "#000" }}>
                        200
                      </option>
                      <option value="unlimited" style={{ color: "#000" }}>
                        Unlimited
                      </option>
                    </select>
                  </div>
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setExportAllFiles(e.target.value === "all")
                      }
                      className="w-full rounded-lg border border-white/15 bg-black/40 px-3 py-2 text-sm text-white outline-none transition focus:border-cyan-400/60 focus:ring-1 focus:ring-cyan-400/40 relative z-50"
                    >
            ...
            >
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex flex-wrap gap-2">
                        {(depsDetected.node || []).length === 0 && (
                          <div className="text-white/50">None detected</div>
                        )}
              ...
              <div className="mt-4 flex items-center justify-end gap-2">
                ...
                <button
                  type="button"
                  disabled={
                    isInstallingDeps || !depsDetected || depsDetected.error
                  }
                  onClick={async () => {
                    ...
                    try {
                      ...
                      try {
                        toast.push({
                          ...
                          message: "Dependencies installed (see console)",
                        });
                      } catch {}
